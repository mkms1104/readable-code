...
public class GameBoard {
    ...
    private void initailizeGameStatus() {
    ...
    private void openAndPushCellAt(Stack<CellPosition> stack) {
        ...
        List<CellPosition> surroundedPositions = calculateSurroundedPositions(currentCellPosition, landMineCount, landMineCount);
